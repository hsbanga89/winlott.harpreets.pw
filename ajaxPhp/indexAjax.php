...
$result_set = db_connect_result($get_all_predictions);
...
//    Make column names
    ...
    $lott_date = $date_array['this-date'];
    ...
    db_connect_result($insert_predictions);
...
//    if numbers have already been predicted earlier today, just display
    while ($row = $result_set->fetch_assoc()) {
        ...
        $lott_date = $row['predictdate'];
    }
}

send_to_ajax($lott_array, $lott_date);